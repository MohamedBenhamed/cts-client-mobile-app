import 'package:estore_client/CustomerAccountSettings/data/datasource/get_customer_info_by_id_remote_datasource.dart';
import 'package:estore_client/CustomerAccountSettings/data/repositories/get_customer_info_by_id_repository.dart';
import 'package:estore_client/CustomerAccountSettings/domain/repositories/get_customer_info_by_id_base_repository.dart';
import 'package:estore_client/CustomerAccountSettings/domain/usecases/get_customer_by_id_usecase.dart';
import 'package:estore_client/auth/reqistration/data/datasource/add_customer_remote_data_source.dart';
import 'package:estore_client/auth/reqistration/data/repositories/add_user_repository.dart';
import 'package:estore_client/auth/reqistration/domain/repositories/add_customer_base_repository.dart';
import 'package:estore_client/auth/reqistration/domain/usecases/add_customer_usecase.dart';
import 'package:estore_client/auth/login/data/datasource/auth_local_data_source.dart';
import 'package:estore_client/auth/login/data/datasource/auth_remote_data_source.dart';
import 'package:estore_client/auth/login/data/repositories/auth_customer_repository.dart';
...
import 'package:estore_client/storeMain/data/repositories/get_all_subcategories_repository.dart';
